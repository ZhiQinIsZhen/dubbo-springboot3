CREATE TABLE `dubbo_staff`.`staff_role` (
...
CREATE TABLE `dubbo_staff`.`system_role` (
                                             `role_id` int(8) unsigned NOT NULL COMMENT '角色ID',
...
CREATE TABLE `dubbo_staff`.`system_authority` (
...
CREATE TABLE `dubbo_staff`.`system_role_authority` (
                                                       `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                                       `role_id` int(8) unsigned NOT NULL COMMENT '角色ID',
                                                       `authority_id` int(8) unsigned NOT NULL COMMENT '权限ID',
                                                       `create_user` bigint(20) NOT NULL COMMENT '创建者',
...
CREATE TABLE `dubbo_staff`.`staff_authority` (
                                                 `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                                 `staff_id` bigint(20) unsigned NOT NULL COMMENT '员工ID',
                                                 `authority_id` int(8) unsigned NOT NULL COMMENT '权限ID',
