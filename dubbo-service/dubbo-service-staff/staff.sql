CREATE DATABASE `dubbo_staff` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';


CREATE TABLE `dubbo_staff`.`staff_auth_email` (
...
CREATE TABLE `dubbo_staff`.`staff_auth_mobile` (
                                                   `staff_id` bigint(20) unsigned NOT NULL COMMENT '员工ID',
...
CREATE TABLE `dubbo_staff`.`staff_info` (
...
CREATE TABLE `dubbo_staff`.`staff_login_log` (
...
CREATE TABLE `dubbo_staff`.`staff_logout_log` (
                                                  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                                  `staff_id` bigint(20) unsigned NOT NULL COMMENT '员工ID',
