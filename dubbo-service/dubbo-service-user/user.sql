CREATE DATABASE `dubbo_user` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';

CREATE TABLE `dubbo_user`.`user_auth_email` (
...
CREATE TABLE `dubbo_user`.`user_auth_mobile` (
                                                 `user_id` bigint(20) unsigned NOT NULL COMMENT '用户ID',
...
CREATE TABLE `dubbo_user`.`user_info` (
...
CREATE TABLE `dubbo_user`.`user_login_log` (
...
CREATE TABLE `dubbo_user`.`user_logout_log` (
                                                `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                                `user_id` bigint(20) unsigned NOT NULL COMMENT '用户ID',
