CREATE DATABASE `dubbo_auth` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';

CREATE TABLE `dubbo_auth`.`auth_source`  (
...
INSERT INTO `dubbo_auth`.`auth_jwt` VALUES
